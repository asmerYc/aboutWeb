/*
 * @Author: your name
 * @Date: 2021-02-01 14:16:31
 * @LastEditTime: 2021-02-01 14:18:11
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /aboutWeb/wirteCode/instanceOf.js
 */
...
function myInstanceOf(left,right){
    ...
    while(true) {
        ...
        if(proto === right.prototype) return true;  //如果完全相等  直接return true
